...
import 'package:go_eng/questions/intermediate/iquestion3.dart';

class IQuestion2 extends StatefulWidget {
  final String email;
  final int score;
  final String type;
  IQuestion2(this.email, this.score, this.type, {Key key}) : super(key: key);
  @override
  _IQuestion2 createState() => _IQuestion2();
}

GlobalKey<ScaffoldState> scaffoldKey = new GlobalKey();

class _IQuestion2 extends State<IQuestion2> {
  List<String> options = [];
  var widthX = 150.0;
  var heightY = 150.0;
  var pad = 0.0;
              ...
              new FlatButton(
                ...
                onPressed: () {
                  Navigator.of(context).push(
                    ...
                    return new IQuestion3(tempEmail, tempScore, tempType);
                  }));
                },
              ),
            ],
